...
const facialHygiene = [{
id: 1,
productName: "Balsamo labial",
productDescription: "Repara, hidrata y calma los labios resecos y agrietados. Con manteca de cacao, karate, aceite de almendras, aceite de coco y pigmento natural rojizo que realza el brillo natural de los labios.",
amount: 15,
unit: "Gr",
price: 335
},
...
{
id: 5,
productName: "Protector solar facial",
productDescription: "¿SABÍAS QUE LOS DERMATOLOGOS RECOMIENDAN USAR PROTECTOR SOLAR FACIAL TODO EL AÑO? HAYA SOL O ESTE NUBLADO? Nosotras también, pero queremos que lo hagas de manera natural y cuidando al medioambiente por eso creamos emulsión liviana con protección solar alta (45-50). Vegana & libre de parabenos 🐰🐭 Con extracto de URUCUM, agua de ROSAS, aceite de pepitas de UVA & aceite de SESAMO 🌷🌴🌾 Protege, hidrata & suaviza el rostro. Previene el envejecimiento prematuro. No obstruye los poros ni deja sensación grasa. Apto para todo tipo de piel ✨ Envase de 125cc reutilizable ♻️",
amount: 125,
unit: "Ml",
price: 710
},
{
id: 6,
productName: "Eterna(Anti age)",
productDescription: "Emulsión facial hidratante profunda y delicada.Ideal para pieles secas o con signos de envejecimiento. Reduce las líneas de expresión, regenera, reafirma. Suaviza y da luminosidad. Con un exquisito aroma a jazmín, que levanta él animo y expande la belleza desde el interior. Rosa mosqueta para atenuar manchas y aportar ácidos esenciales como el omega 6, omega 3, linoléico y vitamina A. Y todas las propiedades nutritivas e hidratantes del argán, el coco y la manteca de karité. •Presentación en 50cc •Envase de vidrio reutilizable",
amount: 50,
unit: "Gr",
price: 670
},
{
id: 7,
productName: "Equilibra(Piel grasa)",
productDescription: "Compuesta por: Aceite de jojoba premium, extraido de arboles cuidados y respetados en una finca nacional en la provincia de La Rioja. Este aceite penetra muy bien en la piel, es antioxidante y ayuda a prevenir arrugar y neutralizar los radicales libres. También se recomienda como remedio para el acne y para tratar las pieles grasas. Extracto botanico de Aloe Vera, con sus multiples y favorables propiedades para la piel, regenerante y cicatrizante entre otras. Cera vegetal que actua reforzando la proteccion de la barrera cutanea y la hace apta para veganxs. Y aceite esencial de tea tree que minimiza la apariencia de los poros, tiene efecto astringente y antiseptico. Si tu piel es mixta o grasa esta crema es la ideal para vos! Presentacion en envase de vidrio de 50cc. Retornable. Animate a probarla y contanos tu experiencia!!",
amount: 50,
unit: "Gr",
price: 670
},
{
id: 8,
productName: "Calma (Piel sensible)",
amount: 50,
unit: "Gr",
price: 670
}
